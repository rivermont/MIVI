...
Observations needing phenology annotation: 11010
...
<!-- quality_grade=research&identifications=any&geoprivacy=open&place_id=97394&taxon_id=116710&verifiable=true&acc_below_or_unknown=28000 -->
...
Todo: remove known problem records<br/>  
130398055 - not flowering,<br/>  
...
```{R}
table1(~ latitude + longitude + elevation + julian | stage, data=mivi_all %>% mutate(stage=addNA(stage)))
```
