...
```{R, eval=FALSE}
coords <- data.frame(x=mivi_annotate$longitude,
                     y=mivi_annotate$latitude, ele_id=mivi_annotate$id)
# use slice(1:100) to get a subset for reducing retrieval time
